...
profiles:
  - icon: at-symbol
    url: 'mailto:jin.huang@zju.edu.cn'
    label: E-mail Me
  # - icon: brands/x
  #   url: https://twitter.com/
  - icon: brands/instagram
    url: https://www.instagram.com/ethan.jin.huang/
  - icon: brands/github
    url: https://github.com/ethanjinhuang
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/jin-huang-57b599264/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?hl=en&user=dFbcMfIAAAAJ&view_op=list_works&sortby=pubdate
  - icon: academicons/orcid
    url: https://orcid.org/my-orcid?orcid=0000-0003-1309-8329
